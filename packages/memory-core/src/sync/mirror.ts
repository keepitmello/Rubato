...
export const CONFIG_KEY = "rubato.memoryRepository.url"
...
export const SYNC_PUSH_ENV = "RUBATO_MEMORY_PUSH_SYNC"
 ...
 * backgrounds the push unless `RUBATO_MEMORY_PUSH_SYNC=1` forces foreground.
 */
