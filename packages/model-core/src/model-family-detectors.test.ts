...
describe("model family detectors", () => {
  ...
  test("#given Claude Fable 5 model ids #then detects Fable 5 only", () => {
    expect(isClaudeFable5Model("anthropic/claude-fable-5-1")).toBe(true)
    expect(isClaudeFable5Model("anthropic/claude-fable-5-1[1m]")).toBe(true)
    expect(isClaudeFable5Model("claude-fable-5-1")).toBe(true)
  ...
  test("#given Claude Opus 4.7+ model ids #then detects 4.7 and later only", () => {
    ...
    expect(isClaudeOpus47OrLaterModel("anthropic/claude-fable-5-1")).toBe(true)
    expect(isClaudeOpus47OrLaterModel("anthropic/claude-fable-5-1[1m]")).toBe(true)
  ...
  test("#given Claude Fable/Mythos model ids #then detects fable and mythos families", () => {
    expect(isClaudeFableOrMythosModel("anthropic/claude-fable-5-1")).toBe(true)
    expect(isClaudeFableOrMythosModel("claude-fable-5-1")).toBe(true)
    expect(isClaudeFableOrMythosModel("anthropic.claude-fable-5-1")).toBe(true)
