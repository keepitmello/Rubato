export const RUBATO_INTERNAL_INITIATOR_MARKER = "<!-- RUBATO_INTERNAL_INITIATOR -->"

export const RUBATO_INTERNAL_NOREPLY_MARKER = "<!-- RUBATO_INTERNAL_NOREPLY -->"

const INTERNAL_INITIATOR_MARKER_DETECT_PATTERN = /<!--\s*RUBATO_INTERNAL_INITIATOR\s*-->/
const INTERNAL_NOREPLY_MARKER_DETECT_PATTERN = /<!--\s*RUBATO_INTERNAL_NOREPLY\s*-->/
const INTERNAL_INITIATOR_MARKER_PATTERN = /\n*<!--\s*RUBATO_INTERNAL_INITIATOR\s*-->\s*/g
const INTERNAL_NOREPLY_MARKER_PATTERN = /\n*<!--\s*RUBATO_INTERNAL_NOREPLY\s*-->\s*/g
...
export function createInternalAgentTextPart(text: string): {
  ...
  return {
    type: "text",
    text: `${cleanText}\n${RUBATO_INTERNAL_INITIATOR_MARKER}`,
  }
}
...
export function withInternalNoReplyMarker<T extends { type: "text"; text: string }>(
  ...
  return { ...part, text: `${part.text}\n${RUBATO_INTERNAL_NOREPLY_MARKER}` }
}
