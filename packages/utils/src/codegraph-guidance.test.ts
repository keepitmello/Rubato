...
describe("CodeGraph initialization guidance", () => {
  ...
  test("#given an uninitialized project #when guidance is built #then it points to the Rubato global store", () => {
    // when
    ...
    expect(guidance).toContain('"/Users/me/.rubato/codegraph/projects/project-')
