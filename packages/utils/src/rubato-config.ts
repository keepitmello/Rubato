...
export type RubatoConfig = HarnessOverrideConfig & {
  readonly "[codex]"?: HarnessOverrideConfig
  readonly "[senpi]"?: HarnessOverrideConfig
...
export interface RubatoConfigValidationResult {
...
export function validateRubatoConfig(value: unknown): RubatoConfigValidationResult {
  const errors: string[] = []
