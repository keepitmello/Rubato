...
import { handleLspMcpRequest, type JsonRpcId, type JsonRpcResponse } from "@rubato/lsp-core/mcp";
import { createStandaloneMcpRequestContext, runWithRequestContext } from "@rubato/lsp-core/request-context";
import { jsonRpcId, type ParentWatchdogConfig, runJsonRpcStdioServer, successResponse } from "@rubato/mcp-stdio-core";
import { isPlainRecord } from "@rubato/mcp-stdio-core/record";
...
function projectRootFromOpenCodeConfigPath(path: string): string | undefined {
	...
	if (configDirName !== ".opencode" && configDirName !== ".rubato") return undefined;
