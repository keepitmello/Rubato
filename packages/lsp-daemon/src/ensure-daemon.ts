...
export { InvalidRuntimeOverrideError, RUBATO_LSP_DAEMON_CLI, resolveDaemonRuntime } from "./runtime-contract.js";
...
export function pingDaemon(
	...
	return new Promise((resolve) => {
		...
		socket.once("connect", () => {
			socket.write(
				encodeJsonLine({ jsonrpc: "2.0", id: 1, method: "rubato/ping", params: { _rubato: authEnvelope(token) } }),
			);
		});
