import { shellEscapeForDoubleQuotedCommand } from "@rubato/utils"
...
export function buildTmuxPlaceholderCommand(description: string): string {
  ...
  return `${TMUX_COMMAND_SHELL} -c "printf '%s\\n%s\\n' \\"Rubato subagent pane ready: ${escapedDescription}\\" \\"Focus this pane to attach.\\"; while :; do sleep 86400; done"`
}
