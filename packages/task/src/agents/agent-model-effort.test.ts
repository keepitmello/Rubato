...
describe("agent model entries carrying effort", () => {
  test("#given a rubato agent whose models carry effort #when bridged #then the entry objects survive onto the definition", () => {
    // given
    const config = {
      agents: {
        explore: {
  ...
  test("#given a rubato agent whose model entries carry canonical reasoning #when bridged #then the entry reasoning is preserved on the candidate", () => {
  ...
  test("#given a rubato agent with plain string models #when bridged #then the legacy strings are preserved verbatim", () => {
    // given
