...
import type { RuntimeStateMember } from "@rubato/team-core/types"
...
describe("shutdown helpers", () => {
  test("#given the rubato shutdown-helpers parity set #when DELETABLE_MEMBER_STATUSES is read #then it is exactly completed/shutdown_approved/errored", () => {
    // given / when
