...
import {
  ...
  getTasksDir,
  getTeamSpecPath,
} from "@rubato/team-core/team-registry"
 ...
 * baseDir passed to the team-core path helpers, NOT the rubato-compatible `.rubato/teams` discovery path.
 */
...
/**
 * The rubato-compatible `<projectRoot>/.rubato/teams/<name>/config.json` path. Discovery-only: it is read
