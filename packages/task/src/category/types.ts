...
import type { RubatoCategoryConfig } from "@rubato/config-core"

import type { ResolvedModelRecord } from "../state"

export type BuiltinCategoryDefinition = {
  readonly name: string
  readonly config: RubatoCategoryConfig
...
export type ResolvedChildSpec<TModel extends SenpiModelPort> = {
  ...
  readonly thinking?: RubatoCategoryConfig["thinking"]
  readonly reasoningEffort?: RubatoCategoryConfig["reasoningEffort"]
  readonly tools?: RubatoCategoryConfig["tools"]
