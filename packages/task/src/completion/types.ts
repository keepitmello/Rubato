...
export type ParentNotifierMessage = {
  readonly customType: "rubato.task.completion" | "senpi-task.completion"
...
/** @deprecated Pre-rename alias kept for the rubato-runtime caller until todo 18 updates it. */
...
export type CompletionNotifier = {
  ...
  /** Thin alias of reconcileUnnotifiedNotifications for the pre-rename rubato-runtime caller (todo 18). */
