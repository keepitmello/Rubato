...
// Ported from packages/rubato-opencode/src/tools/delegate-task/builtin-categories.ts.
...
export const DEFAULT_CATEGORIES: Readonly<Record<string, RubatoCategoryConfig>> = Object.fromEntries(
