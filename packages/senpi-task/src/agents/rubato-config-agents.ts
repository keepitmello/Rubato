import type { RubatoAgentDef, RubatoConfig } from "@rubato/config-core"
 ...
 */
export function mapRubatoConfigAgents(config: RubatoConfig): Readonly<Record<string, AgentDefinition>> {
...
function toAgentDefinition(name: string, def: RubatoAgentDef): AgentDefinition {
