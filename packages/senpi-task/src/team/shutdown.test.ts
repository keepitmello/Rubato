...
} from "@rubato/team-core/team-state-store"
import { TeamSpecSchema, type RuntimeStateMember } from "@rubato/team-core/types"
...
function tempConfig(): TeamCoreConfig {
  ...
  return toTeamCoreConfig(RubatoTaskSettingsSchema.parse({}), dir)
}
