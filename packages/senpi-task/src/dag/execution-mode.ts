...
export type DagExecutionModeSources = {
  ...
  // The narrow slice of the loaded rubato.json the resolver reads. The full parsed RubatoConfig
...
// spec.execution_mode ?? agentDef.executionMode ?? rubato.json task.default_execution_mode
...
// mirroring the harness-side merge in rubato-runtime's resolveTaskAgents.
