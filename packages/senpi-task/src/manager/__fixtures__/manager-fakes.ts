...
export function settings(overrides: Record<string, unknown> = {}): RubatoTaskSettings {
  return RubatoTaskSettingsSchema.parse({ global_concurrency: 0, ...overrides })
}
