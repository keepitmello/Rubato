...
describe("resolveStateDir", () => {
  test("#given no task state override #when resolved #then project rubato senpi-task directory is used", () => {
    // given
    ...
    // then
    expect(stateDir).toBe(join(project, ".rubato", "senpi-task"))
  })
