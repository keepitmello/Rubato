...
import { createDagFileStore, createDagManager, DagManagerError, type DagManager, type DagNodeId, type DagRunId } from "@rubato/senpi-task/dag"
...
function tempProject(): string {
  const directory = fs.mkdtempSync(join(tmpdir(), "rubato-runtime-dag-tool-"))
