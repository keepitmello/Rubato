...
describe("event-bridge native task RPC snapshots", () => {
  it("#given current and foreign session tasks #when session_start completes #then it emits an initial rubato.task.updated snapshot only for the captured parent session", async () => {
