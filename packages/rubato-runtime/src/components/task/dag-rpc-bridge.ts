...
const DAG_EVENT_CHANNEL = "rubato.dag.event"
const DAG_HEARTBEAT_CHANNEL = "rubato.dag.heartbeat"
const DAG_ACTIVITY_CHANNEL = "rubato.dag.activity"
// The wholesale-replace channel. It coexists with the seq ledger above: consumers that keep no
// per-event state (rubato-desktop-app) swap their whole run list on each payload.
const DAG_UPDATED_CHANNEL = "rubato.dag.updated"
