...
// The rubato.dag.updated body: a wholesale replace, never a delta, so the whole owned run set goes out
...
// snake_case is the wire contract rubato-desktop-app already consumes for rubato.task.updated; optional
