...
import type { DreamOrigin } from "@rubato/memory-core"
...
export function resolveDreamTriggerSettings(settings: RubatoMemorySettings, agentName?: string): DreamTriggerSettings {
