 ...
 *    specifically, and no Rubato consumer of resources_discover existed before this component
 ...
 *
 * letta 5-layer -> Rubato mapping: project -> senpi project scope; agent (memfs repo skills/)
 * -> THIS layer (resources_discover skillPaths); memory-fallback ($LETTA_MEMORY_DIR) -> NO
 * Rubato analog (recorded divergence); global -> senpi user scope; bundled -> senpi builtin.
 */
