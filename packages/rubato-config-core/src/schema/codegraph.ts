...
const RubatoCodegraphSettingsShape = {
  enabled: z.boolean(),
...
export const RubatoCodegraphSettingsLayerSchema = z.object(RubatoCodegraphSettingsShape).partial().strict()

export const RubatoCodegraphSettingsSchema = RubatoCodegraphSettingsLayerSchema.extend({
...
export type RubatoCodegraphSettings = z.infer<typeof RubatoCodegraphSettingsSchema>
export type RubatoCodegraphSettingsLayer = z.infer<typeof RubatoCodegraphSettingsLayerSchema>
...
export const SETTING_HARNESS_SUPPORT: Record<SettingPath, readonly HarnessId[]> = {
  ...
  "codegraph.watch_debounce_ms": ["opencode", "senpi"],
} as const
