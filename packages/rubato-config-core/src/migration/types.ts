import { DEFAULT_WRITE_FILE_SYSTEM, type RubatoConfigEdit, type RubatoConfigWriteFileSystem } from "../writer"
...
export type MigrationFileSystem = RubatoConfigWriteFileSystem & {
