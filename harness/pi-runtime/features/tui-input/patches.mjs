...
export function patchStdinBufferUnicode(source) {
  // Tradeoff: stock mapped every single byte >127 to ESC+(byte-128) (Alt+letter). Hangul lead 0xEA must not be stolen; keep 8-bit meta only for 0x80-0xC1.
