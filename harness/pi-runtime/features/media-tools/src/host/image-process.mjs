import { convertToPng, formatDimensionNote, resizeImage } from "../host-sdk.mjs";
...
function conversionHint(from, to) {
	return !from || from === to ? undefined : `[Image converted from ${from} to ${to}.]`;
}

/** Public-export composition of stock Pi's non-exported processImage helper. */
