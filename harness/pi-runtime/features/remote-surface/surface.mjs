// Port of harness/rubato-pi/src/extensions/remote-surface.mjs for stock Pi.
// Engine-facing imports are local: projection and InteractiveActionDispatcher
// are reused from the product files via catalog/sourcePath; session-metrics is
// a slim stock port because the product module pulls Senpi statusline/TUI.
