...
// The stock lazy adapter does not forward Cursor's local-work state and does
// not cancel an inner HTTP/2 iterator when its consumer returns.
import { lazyApi } from "../rubato-features/providers/cursor-lazy.mjs";
/**
