...
import { createRemovedToolHintRegistrar, type RemovedToolHintContextEvent } from "./extension/stock-host-adapter.ts";
...
export default function senpiCodemode(pi: CodemodeExtensionAPI, options: SenpiCodemodeOptions = {}): void {
	...
	const registerEvalForRuntime = (
		...
		// action methods throw while extensions are still loading. An unreadable registry means
		// "do not teach a tool we cannot confirm"; session_start/model_select re-register live.
