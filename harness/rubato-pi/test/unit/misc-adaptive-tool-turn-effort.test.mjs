...
test("adaptive 모델은 사고 없는 tool_use 턴 뒤에도 thinking/effort 를 유지한다", () => {
  ...
  assert.match(next, /!supportsAdaptiveThinking\(model\) && finalAssistantTurnStartsWithToolUse\(params\.messages\)/);
