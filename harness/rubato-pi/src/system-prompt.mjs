...
- Only core tools are exposed initially. Use tool_search for other capabilities (agents, teams, memory, history, terminal control, web, code analysis); then call the activated tools directly.
