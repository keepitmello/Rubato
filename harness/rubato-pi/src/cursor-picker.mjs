...
// (`case-studies/provider-routing/cursor-route-verdict`: grok, gpt-5.6-sol,
// claude-fable-5-1, claude-opus-5, gemini-3.8-flash, kimi-k3, composer-2.5).
// live id 는 `grok-4.7` 이다 — 4.6 까지는 `cursor-grok-4.6` 이었다.

import { CURSOR_GROK_ID, presentCursorGrokFast } from "./cursor-grok-fast.mjs";
