...
const HEUR_NEEDLE = "        if (!isNonOverflow && hasTokenEvidence && RESOURCE_EXHAUSTED_PATTERN.test(message.errorMessage)) {\n            return true;\n        }\n    }\n";
...
/** pi-ai series 20260830-0449Z-codex-overflow-detection. */
export function injectOverflow(source) {
  let next = replaceOnce(source, PAT_NEEDLE, PAT_REPLACEMENT, "overflow codex patterns");
  return replaceOnce(next, HEUR_NEEDLE, HEUR_REPLACEMENT, "overflow 99% window heuristic");
}
