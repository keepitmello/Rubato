---
name: dispatched
description: "Contract for a session that works from a delegated brief, first leg or a later one in the same session: what binds, what must be verified, what a map returns."
---
...
## A later leg in the same session
