...
```bash
node ${CODEX_HOME:-$HOME/.codex}/skills/rubato-tui-verify/scripts/render-component.mjs --demo thinking
node ${CODEX_HOME:-$HOME/.codex}/skills/rubato-tui-verify/scripts/render-component.mjs --demo thinking --expand
node ${CODEX_HOME:-$HOME/.codex}/skills/rubato-tui-verify/scripts/render-component.mjs --demo thinking --raw   # OSC8 링크 확인
```
