...
- Package/install/provider/skill checks: 33 passed, no skips.
...
- Duplicate global skills were disabled through managed configuration only;
  original files and symlinks were not moved or deleted.
