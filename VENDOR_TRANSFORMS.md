...
| core-session | `core-` | compaction 4부작 + 예산, retry/stream watchdog, /skill: 인라인, user-abort 후 compact, speculative 제거, service-tier fast 기억(Codex·xAI·Claude Opus), Codex overflow 감지, 모델별 client compact 임계점 |
